...
impl Default for LLMConfiguration {
    fn default() -> Self {
        ...
        providers.insert("openai-nano".to_string(), LLMProviderConfig {
            provider_type: LLMProviderType::OpenAI,
        ...
        providers.insert("claude-4-sonnet".to_string(), LLMProviderConfig {
        ...
        providers.insert("claude-4-opus".to_string(), LLMProviderConfig {
            provider_type: LLMProviderType::Anthropic,
        ...
        providers.insert("claude-4.1-opus".to_string(), LLMProviderConfig {
            provider_type: LLMProviderType::Anthropic,
        ...
        providers.insert("lmstudio".to_string(), LLMProviderConfig {
        ...
        providers.insert("gpt4all".to_string(), LLMProviderConfig {
            provider_type: LLMProviderType::Local,
        ...
        providers.insert("jan".to_string(), LLMProviderConfig {
            provider_type: LLMProviderType::Local,
            display_name: "Jan".to_string(),
            enabled: false,
            default_model: "trinity-v1".to_string(),
            available_models: vec![
                "trinity-v1".to_string(),
        ...
        providers.insert("custom".to_string(), LLMProviderConfig {
            provider_type: LLMProviderType::Local,
